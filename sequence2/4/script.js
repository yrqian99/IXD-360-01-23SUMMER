...
for (var i = 0; i < numPaths; i++) {
  ...
  path.setAttribute('stroke', 'rgba(241, 247, 225, 0.5)');
  path.setAttribute('fill', 'transparent');
  path.setAttribute('stroke-width', '184');
  path.setAttribute('stroke-dasharray', '0 1.3 0');
...
function updatePaths() {
    ...
    // path.setAttribute('stroke-dasharray', `20 ${strokeGap}`);
  ...
  // var HOST = "172.20.10.8";
    ...
    document.body.addEventListener("touchmove", function(e) {
      ...
      if (e.touches.length > 1) {
        ...
        strokeGap = 20 - (1 - normalizedDistance) * 20 ;
        console.log(strokeGap);
    ...
    //       window.location.href = `http://${HOST}:5500/sequence/dotLine2/index.html`;
    //   }, 2000);
    // }
