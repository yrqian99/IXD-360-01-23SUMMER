...
for (var i = 0; i < numPaths; i++) {
  ...
  path.setAttribute('stroke-width', '300');
  path.setAttribute('stroke-dasharray', '0 1.5 0');
  ...
  // var HOST = "172.20.10.8";
    ...
    if(normalizedDistance === 0){
      ...
      setTimeout(function() {
          ...
          window.location.href = `http://${HOST}:5500/sequence2/4/index.html`;
      }, 6000);
    }
