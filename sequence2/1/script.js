...
path.setAttribute('stroke-width', '1050');
path.setAttribute('stroke-dasharray', '0 2.5 0');
...
// var HOST = "172.20.10.8";
  ...
  if(normalizedDistance === 0){
    ...
    setTimeout(function() {
        ...
        window.location.href = `http://${HOST}:5500/sequence2/2/index.html`;
    }, 7000);
  }
