...
window.onload = function() {
    ...
    for (var i = 0; i < numPaths; i++) {
      ...
      path.setAttribute('stroke', 'rgba(228, 238, 242, 0.05)');
      path.setAttribute('fill', 'rgba(124, 202, 235, 0.03)');
    ...
    function updatePaths() {
      paths.forEach(function(path, i) {
        ...
        path.setAttribute('fill', `rgba(${124 + colorFactor}, ${202 - colorFactor}, ${235 - colorFactor}, 0.1)`);
        });
    }
