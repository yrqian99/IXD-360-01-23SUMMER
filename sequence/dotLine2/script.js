...
window.onload = function() {
  ...
  path.setAttribute('stroke-dasharray', '0 4 0');
  ...
  document.body.addEventListener("touchmove", function(e) {
    ...
    if (e.touches.length > 1) {
      ...
      opacity = 0.0 + (1 - normalizedDistance)* 0.01;
  ...
  if(normalizedDistance === 0){
    ...
    setTimeout(function() {
        ...
        window.location.href = `http://${HOST}:5500/sequence/lineShape/index.html`;
    }, 2000);
  }
